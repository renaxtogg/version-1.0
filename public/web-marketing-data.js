...
(function () {
  ...
  var FALLBACK_PLANS = [
    ...
    { slug: 'emprendedor-delivery', name: 'Emprendedor Delivery', headline: 'Tu delivery, en digital',
      description: 'La versión a domicilio del Emprendedor: recibí pedidos de delivery con un menú digital y la ubicación del cliente, y gestionalos desde el panel de Admin. Para negocios que atienden solo por delivery, sin salón. Sin flota de repartidores ni seguimiento en mapa (eso es Premium).',
      price_monthly_gs: 150000, price_annual_gs: 1500000, currency: 'PYG',
      plan_config: { panels: ['delivery-cliente'], features: ['admin:inventory'], max_tables: 0, max_menu_items: 30, max_users: {} },
      features: ['Pedidos a domicilio (menú digital)', 'Gestión de pedidos (Admin)', 'Control de Insumos', '30 ítems'],
      badge: null, is_recommended: false, is_enterprise: false },
