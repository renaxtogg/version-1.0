/* ═══════════════════════════════════════════
   MYTHOS ICONS — set SVG inline (estilo Lucide)
   Reemplaza emojis. Hereda color con `currentColor` y tamaño 1em por defecto.

   Uso JS plano:
     elem.innerHTML = MythosIcons.html('dashboard');
     elem.innerHTML = MythosIcons.html('bell', { size: 18 });

   Uso React (Babel CDN):
     React.createElement('span', { dangerouslySetInnerHTML: { __html: MythosIcons.html('bell') } })
     o más simple:
     <span dangerouslySetInnerHTML={{__html: MythosIcons.html('bell')}}/>
═══════════════════════════════════════════ */
(function () {
  'use strict';

  // Todos los paths se renderizan dentro del wrapper SVG común.
  // currentColor permite heredar el color del texto.
  var P = {
    // Navegación / paneles
    ...
    truck: '<path d="M5 18H3V6h13v12h-4"/><path d="M16 8h4l3 4v6h-3"/><circle cx="9" cy="18" r="2"/><circle cx="18" cy="18" r="2"/>',
    ...
    store: '<path d="M3 9l1.5-6h15L21 9"/><path d="M3 9v11a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9"/><path d="M3 9h18"/><path d="M9 22V12h6v10"/>',
    ...
    receipt: '<path d="M4 4v17l3-2 3 2 3-2 3 2 3-2V4z"/><path d="M8 9h8M8 13h8M8 17h5"/>',
    ...
    utensils: '<path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M18 2a4 4 0 0 0-4 4v5c0 1.1.9 2 2 2h4V2z"/><path d="M18 13v9"/>',
    ...
    boxes: '<path d="M7 16.5 2 13.5V8.5l5-3 5 3v5L7 16.5z"/><path d="M22 13.5l-5 3-5-3v-5l5-3 5 3v5z"/><path d="M12 8.5V3.5l-5-3-5 3v5l5 3 5-3z"/>',
  ...
  window.MythosIcons = { html: html, paths: P };
})();
