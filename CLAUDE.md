...
3. ~~**Customers / CRM** — crear tabla y conectar UI existente~~ ✅ hecho (mig 196: alta de clientes en Admin/Caja/Mozo/QR/Delivery + tipos configurables)
